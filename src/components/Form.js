...
import {Button, TextareaAutosize, Container, Grid, Typography} from '@mui/material';
            ...
            <div>
                ...
                >
                    <Box sx={style}>
                        ...
                        <div style={{textAlign: "center", marginTop: "5px"}}><Button onClick={handleClose}> close</Button></div>
                    </Box>
                </Modal>
            </div>
