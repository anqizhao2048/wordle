            ...
            <Grid item xs={8}>
                <div style={{fontSize: '20px', fontFamily: "MONOSPACE"}}>
                    <div style={{marginTop: '10px'}}>
                        Please input a <span style={{color: "darkblue"}}>{currentWord.length}-letter</span> word to
                        guess
                    </div>
                    <div style={{marginTop: '10px'}}>You can try <span
                        style={{color: "green"}}>{allowedAttemptTime}</span> times!
                    </div>
                    ...
                    <div style={{marginTop: '20px'}}>tried words:</div>
                    {
                        triedWords.map((word, index) => <div style={{marginTop: '10px'}} key={index}><StyledTriedWord
                            word={word} currentWord={currentWord}/></div>)
                    }
                </div>
            </Grid>
            <Grid item xs={2}></Grid>
