...
function RulePage() {
    return (
        <div>
            ...
            <div style={{marginTop: "40px", fontFamily: "MONOSPACE"}}>
                <Grid container>
                    <Grid item xs={4}/>
                    <Grid item xs={5}>
                        ...
                        <ul>
                            ...
                            <li>
                                <div style={{marginTop: "20px"}}>hard game: guess a 7-letter word with 5 opportunities
                                </div>
                            </li>
                        </ul>
                        ...
                        <div style={{marginTop: "20px"}}>
                            ...
                            style={{backgroundColor: "green"}}>a</span><span
                            style={{backgroundColor: "grey"}}>t</span><span
                            style={{backgroundColor: "grey"}}>e</span><span style={{backgroundColor: "grey"}}>r</span>
                        </div>
                        <div style={{marginTop: "50px"}}/>
                        <h2> Explanation </h2>
                        <p style={{}}>
                            first <span style={{backgroundColor: "yellow"}}>e</span> is in the word but not in the
                            correct
                            spot
                        </p>
                        <p style={{}}>
